...
describe('create-article.dto', () => {
    ...
    it('title field is empty', async () => {
        dto.title = ''
        const ofImportDTO = plainToInstance(CreateArticleDto, dto)
        const errors = await validate(ofImportDTO)
        expect(errors.map((err) => err.property).includes('title')).toBeTruthy()
    })

    it('title field is not string', async () => {
    ...
    it('locality_name field is empty', async () => {
        dto.locality_name = ''
        const ofImportDTO = plainToInstance(CreateArticleDto, dto)
        const errors = await validate(ofImportDTO)
        expect(
    ...
    it('locality_name field is not string', async () => {
